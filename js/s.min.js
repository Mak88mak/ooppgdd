...
! function() {
    var a = parseInt(Date.now() + 1e11 * Math.random()),
        b = {
            ...
            desc: "睿智数独，挑战你的智商。你是不是骨灰级玩家？",
            title: "睿智数独，挑战你的智商。你是不是骨灰级玩家？"
        };
    ...
    var a = {
        ...
        c = {
            ...
            check: function() {
                c.checkErr(), c.data.tm.join("") == c.data.answer && (c.stopTimer(), localStorage.setItem("sudoku_lv" + c.data.lv, c.data.p), a.win.find(".lv").html(c.data.lv + 1), a.win.find(".time").html(a.time.html()), a.win.show(), 
                	// window.location.href="objc://"+"gameOver:/0", //decamincow
                	_czc.push(["_trackEvent", "score", c.data.lv + 1]))
            },
            checkErr: function() {
